...
|---|---|---|
| 🔴 | ⭐ **A geometria que dá dano não é a geometria que se vê.** Ataques inimigos acertam por cone `range + body_radius`/`arc_degrees`; o cue desenha uma faixa de 0,12/0,34 m e quase todos os inimigos usam a mesma pose de arma. Viola o contrato de honestidade e não tem os controlos positivos/negativos 10/10 dentro do jogo. | `game/src/enemies/enemy.gd:695-715` · `game/src/combat/gameplay_cue.gd:71-86` · `game/src/visual/monster_visual.gd:472-481` |
