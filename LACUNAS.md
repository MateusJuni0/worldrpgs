...
| 🟠 | ⭐ **A selecção da Fatia 1 já foi importada deliberadamente em `game/assets/models/`, mas as cápsulas ainda não foram substituídas.** Entraram 35 ficheiros/22,4 MiB: corpo + animações Quaternius, oito malhas Kenney de Brumal e oito módulos KayKit da Toca. ⚠️ `spec/22` escolhe Quaternius Monsters para os orcs, mas esse pack não existe em `art/models/`; até entrar, lanceiro/brutamontes/Vorgar usam variantes provisórias do corpo-base Quaternius para preservar autor e esqueleto comuns | fase 1.2, 01-08 · `game/assets/models/ASSETS.md` |
