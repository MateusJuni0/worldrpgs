...
| 🔴 | ⚠️ **A prova quente 2+5 está finalmente ligada ao jogo e reprova:** `animation_benchmark.gd --mode=hot-gameplay` abre `gameplay.tscn`, apresenta 2 jogadores + 5 inimigos, conduz lock-on/esquiva/movimento pelo `InputMap`, exige resultado visível e recusa `user://` real. Em 30 s de aquecimento + 20 min, 1080p/Mobile, preset médio, FIFO+cap120, deu **58,2 fps, p99 31,371 ms, pior 129,287 ms, 177 draws e 368 493 primitivas**. A máquina era a do Mateus (i7-1255U/16 GiB) com 12 Godot alheios, não o alvo i5-1334U/8 GiB; portanto o vermelho é real, mas a causa ainda não pode ser atribuída. **Donos fora desta árvore:** render deve perfilar/bater superfícies e materiais dos sete actores sem apagar cues/arte; `settings_system.gd` deve consumir cap120; `VERIFICAR.bat` deve executar o gate com APPDATA temporário; depois repetir no Rico com host limpo. | [`PERF`](game/PERF.md) · [`graphics.json`](game/data/graphics.json) · Lei 4 |
