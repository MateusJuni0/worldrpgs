...
| 🔴 | ⭐ **Onze feitiços utilitários prometem efeitos sem mecanismo executável:** `sinal`, `farol_gelado`, `sutura_clara`, `orvalho_lento`, `pele_de_marmore`, `segundo_folego`, `passo_de_centelha`, `ultimo_veu`, `marca_usurario`, `peso`, `espelho`. As fichas têm verbo, mas não têm campos de potência/duração/expiração suficientes; implementá-los obriga a inventar números | revisão 1 · [`66`](spec/66-catalogo-de-magia.md) §6 · `spells.json` |
