...
| 🔴 | A arena final continua acima do p99 de 16,67 ms | A/B na Iris Xe, Mobile/Vulkan, 1080p, 15 s: controlador desligado **104,4 fps/p99 19,629 ms**; ligado e sem duplicar geometria **92,3 fps/p99 22,094 ms**. Ambos falham e havia agentes concorrentes; repetir em host limpo antes de atribuir os 2,465 ms ao controlador. Draw calls/primitivas/memória/VRAM ficaram idênticos (**131 / 279 850 / 97,8 MiB / 166,6 MiB**). |
