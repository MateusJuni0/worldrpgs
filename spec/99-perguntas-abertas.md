...
13. ~~**Hierarquia de chefes: 1+10+20+30 ou 1+30+20?**~~ ✅ **CONTADA na volta 1** — o WP7 tinha arrumado as 4 camadas e deixado o total *"em aberto de propósito — conta-se quando houver mapa"*. Há mapa ([`49-biomas.md`](49-biomas.md)): **1 Ultra + 12 subchefes + 12 guardiões + 36 de campo = 61** `[FABLE]` — exactamente os ~61 prometidos desde o [`00-visao.md`](00-visao.md), agora derivados em vez de palpite. Trocar o número de biomas troca a conta; barato só até à volta 5. → [`04-inimigos-chefes.md`](04-inimigos-chefes.md), [`16-chefes.md`](16-chefes.md)
...
24. **Chefe a dois: aceitamos +40% de vida, ou zero?** — fecha a **pergunta 6**. O jogo de referência multiplica a vida por acompanhante, e a crítica dos próprios jogadores é que fica *esponja* e **castiga quem já está a perder** (a vida extra fica lá depois de um cair). Proposta `[CLAUDE]`: **no máximo +40%, dano igual, e a escala desce quando um morre** — a dificuldade a dois vem de **perguntas diferentes** (área que apanha os dois juntos, ataques que escolhem quem está longe), não de a barra ser mais comprida. → [`39-estudo-profundo.md`](39-estudo-profundo.md) §10
