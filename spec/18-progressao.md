...
> **Poder nunca é aleatório. Aleatório é só o que é conveniência.**

- **Colocado à mão:** armas, skills, pergaminhos, ampliações de frasco, talismãs — cada um tem um sítio no mundo ou um chefe dono (tabelas abaixo). Encontrar é habilidade de exploração; ninguém rola dados para ficar mais capaz.
- **Aleatório dentro de faixas:** materiais (Limalha) e consumíveis futuros — coisas que poupam tempo, nunca coisas que abrem portas.

*Porquê:* loot aleatório de poder cria o farm que a Lei 1 proíbe (matar o mesmo inimigo até "sair a boa") e desequilibra o co-op (um teve sorte, o outro não). *Alternativa descartada:* raridades com rolagem à ARPG — é um jogo de outra espécie; aqui a build vem de escolhas, não de sorte. ✅
...
| Fojo / Costa Quebrada | ~2 600 cada | 20–26 |
| Cimeira | ~3 200 | 30–34 |
...
**Loot instanciado: cada jogador recebe a sua cópia de tudo.** (Formaliza o provisório do WP0.)

- O que um apanha, o outro também recebe — itens colocados, drops de chefe, materiais. Sem corrida ao baú, sem negociação.
- *Porquê:* é a leitura directa do "os itens que dropam pra mim, dropam pra ti" (05:29); zero fricção entre amigos; e o progresso individual do WP10 precisa de inventários independentes de qualquer maneira. *Alternativas descartadas:* **(b)** filtrado por classe — a Lei 3 diz que qualquer um usa qualquer coisa, filtrar por classe contradiz o próprio sistema; **(c)** partilhado com negociação — mais rede, mais atrito, zero ganho entre duas pessoas que já se emprestam armas na mesma sala.
- **A resposta perdida do Mateus (05:40) continua a valer mais do que isto** — se ele se lembrar do que disse, a pergunta 5 fecha-se com a palavra dele, não com a minha.

## A recompensa menor ao ajudar — o 12:34 em números
...
| Chefe já morto para o ajudante | dono 100% · ajudante 40% | o verbo (skill/pergaminho) **só uma vez por personagem** — repetir o chefe do amigo não duplica verbos |

*Porquê 40%:* alto o suficiente para ajudar nunca ser tempo perdido (o espírito do 12:34 é "ajuda compensa"), baixo o suficiente para o caminho mais rápido de progredir ser sempre **o teu próprio mundo** — ajudar é generosidade paga, não a rota óptima de farm. *Alternativa descartada:* 0% ao ajudante — transforma a frase deles em castigo e desincentiva exactamente o co-op que é o pilar 2. ✅ *Teste da Lei 1:* nada disto toca em poder — só em velocidade de acumulação.
...
### Fatia 1 — tudo colocado, nada rolado
...
| As 5 armas | equipamento inicial das classes — **na fatia não caem armas** | a rejogabilidade é trocar de classe/arma entre os dois, não coleccionar |

### Jogo inteiro — o esqueleto por fonte
...
- **NG+ / rejogar de outra classe** com os verbos ganhos — a rejogabilidade natural deste desenho; especifica-se se o jogo zerado pedir
- Talismãs (WP5) nas tabelas de segredos quando entrarem
- Um "livro de feitos" (aparar 100 golpes, zerar sem morrer) que paga em vestes visuais — vaidade, nunca poder
